...
void declareTypesSevenDofExpmap(py::module& m) {
  py::class_<VertexSim3Expmap, BaseVertex<7, Sim3>, std::shared_ptr<VertexSim3Expmap>>(
      m, "VertexSim3Expmap")
      .def(py::init<>())
  ...
  py::class_<EdgeSim3, BaseBinaryEdge<7, Sim3, VertexSim3Expmap, VertexSim3Expmap>,
  ...
  py::class_<EdgeInverseSim3ProjectXYZ,
             ...
             std::shared_ptr<EdgeInverseSim3ProjectXYZ>>(m, "EdgeInverseSim3ProjectXYZ")
      .def(py::init<>())
