...
namespace g2o {
  ...
  namespace
  {
    ...
    std::unique_ptr<BlockSolverBase> AllocateSolver()
    {
      ...
      auto linearSolver = std::unique_ptr<LinearSolverCSparse<typename BlockSolverPL<p, l>::PoseMatrixType>>(
          new LinearSolverCSparse<typename BlockSolverPL<p, l>::PoseMatrixType>());
