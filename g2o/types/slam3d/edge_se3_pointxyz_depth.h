#ifndef G2O_EDGE_PROJECT_DEPTH_NEW_H_
#define G2O_EDGE_PROJECT_DEPTH_NEW_H_
...
namespace g2o {
  ...
  class EdgeSE3PointXYZDepth : public BaseBinaryEdge<3, Vector3d, VertexSE3, VertexPointXYZ> {
  public:
