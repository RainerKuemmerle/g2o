 ...
 ****************************************************************************/
#ifndef G2O_TYPES_SLAM3D_NEW_API_H
#define G2O_TYPES_SLAM3D_NEW_API_H
...
#define G2O_TYPES_SLAM3D_NEW_API __declspec(dllexport)
#else
#define G2O_TYPES_SLAM3D_NEW_API __declspec(dllimport)
#endif
#else
#define G2O_TYPES_SLAM3D_NEW_API
#endif
...
#endif // G2O_TYPES_SLAM3D_NEW_API_H
