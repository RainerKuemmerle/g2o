...
inline void Parser::yy_symbol_value_print_(int yytype,
...
void Parser::yy_symbol_print_(int yytype, const semantic_type* yyvaluep,
                              const location_type* yylocationp) {
  *yycdebug_ << (yytype < yyntokens_ ? "token" : "nterm") << ' '
             << yytname_[yytype] << " (" << *yylocationp << ": ";
  yy_symbol_value_print_(yytype, yyvaluep, yylocationp);
  *yycdebug_ << ')';
}
#endif

void Parser::yydestruct_(const char* yymsg, int yytype, semantic_type* yyvaluep,
...
void Parser::yypop_(unsigned int n) {
...
yynewstate:
  ...
  /* Accept?  */
  if (yystate == yyfinal_) goto yyacceptlab;
...
yybackup:
  ...
  yyn = yypact_[yystate];
  if (yyn == yypact_ninf_) goto yydefault;
  ...
  yyn += yytoken;
  if (yyn < 0 || yylast_ < yyn || yycheck_[yyn] != yytoken) goto yydefault;

  /* Reduce or error.  */
  yyn = yytable_[yyn];
  if (yyn <= 0) {
    if (yyn == 0 || yyn == yytable_ninf_) goto yyerrlab;
    yyn = -yyn;
    goto yyreduce;
  }
...
#line 109 "parser.yy"
    {
      (yysemantic_stack_[(2) - (1)].intList)
          ->push_back((yysemantic_stack_[(2) - (2)].integerVal));
...
#line 124 "parser.yy"
    {
      (yyval.commandNode) =
          new AddNode(*(yysemantic_stack_[(3) - (2)].stringVal),
                      (yysemantic_stack_[(3) - (3)].integerVal), 3);
...
#line 129 "parser.yy"
    {
      ...
      (yyval.commandNode) =
          new AddNode(*(yysemantic_stack_[(6) - (2)].stringVal),
                      (yysemantic_stack_[(6) - (3)].integerVal), 3, values);
...
#line 138 "parser.yy"
    {
      ...
      (yyval.commandNode) = new AddEdge(
          *(yysemantic_stack_[(14) - (2)].stringVal),
          (yysemantic_stack_[(14) - (3)].integerVal), values.size(),
          (yysemantic_stack_[(14) - (4)].integerVal),
          (yysemantic_stack_[(14) - (5)].integerVal), values, information);
...
#line 155 "parser.yy"
    {
      (yyval.commandNode) =
          new AddNode(*(yysemantic_stack_[(3) - (2)].stringVal),
                      (yysemantic_stack_[(3) - (3)].integerVal), 6);
      delete (yysemantic_stack_[(3) - (2)].stringVal);
    } break;
...
#line 160 "parser.yy"
    {
      (yyval.commandNode) =
          new AddNode(*(yysemantic_stack_[(9) - (2)].stringVal),
                      (yysemantic_stack_[(9) - (3)].integerVal), 6);
...
#line 165 "parser.yy"
    {
      ...
      (yyval.commandNode) = new AddEdge(
          *(yysemantic_stack_[(32) - (2)].stringVal),
          (yysemantic_stack_[(32) - (3)].integerVal), values.size(),
          (yysemantic_stack_[(32) - (4)].integerVal),
          (yysemantic_stack_[(32) - (5)].integerVal), values, information);
...
#line 216 "parser.yy"
    {
      (yyval.commandNode) = new QueryState(
          "QUERY_STATE", *(yysemantic_stack_[(2) - (2)].intList));
...
yyerrlab1:
  ...
  for (;;) {
    ...
    if (yystate_stack_.height() == 1) YYABORT;

    yyerror_range[0] = yylocation_stack_[0];
    yydestruct_("Error: popping", yystos_[yystate], &yysemantic_stack_[0],
                &yylocation_stack_[0]);
    yypop_();
    yystate = yystate_stack_[0];
    YY_STACK_PRINT();
  ...
  YY_SYMBOL_PRINT("Shifting", yystos_[yyn], &yysemantic_stack_[0],
                  &yylocation_stack_[0]);
...
yyreturn:
  ...
  while (yystate_stack_.height() != 1) {
    yydestruct_("Cleanup: popping", yystos_[yystate_stack_[0]],
...
std::string Parser::yysyntax_error_(int yystate, int tok) {
  std::string res;
  YYUSE(yystate);
#if YYERROR_VERBOSE
  ...
  if (yypact_ninf_ < yyn && yyn <= yylast_) {
    ...
    for (int x = yyxbegin; x < yyxend; ++x)
      if (yycheck_[x + yyn] == x && x != yyterror_) ++count;
...
/* YYDEFGOTO[NTERM-NUM].  */
const signed char Parser::yydefgoto_[] = {-1, 20, 29, 8, 9, 10, 11, 12, 13, 1};
...
/* TOKEN_NUMBER_[YYLEX-NUM] -- Internal symbol number corresponding
   to YYLEX-NUM.  */
const unsigned short int Parser::yytoken_number_[] = {
    0,   256, 257, 258, 259, 260, 261, 262,
    263, 264, 265, 266, 267, 268, 269, 59};
#endif

/* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
const unsigned char Parser::yyr1_[] = {0,  16, 17, 17, 18, 18, 19, 19,
                                       19, 20, 20, 20, 21, 22, 23, 23,
                                       24, 24, 24, 24, 24, 25, 25, 25};

/* YYR2[YYN] -- Number of symbols composing right hand side of rule YYN.  */
const unsigned char Parser::yyr2_[] = {0, 2, 1, 2, 1, 1, 3, 6, 14, 3, 9, 32,
